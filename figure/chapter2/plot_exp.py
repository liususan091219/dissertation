...
df =  pd.read_csv("exp_out.txt")

sns.heatmap(df, linewidths=.1,ax=axn,cmap='Blues',vmin=0.0, vmax=.35,xticklabels = False, annot=True,fmt=".2f")
...
f.savefig("exp_mat.pdf",bbox_inches='tight')
